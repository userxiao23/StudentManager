    ...
    <script type="text/javascript">
        var _menus = {"menus":[
                ...
                {"menuid":"1","icon":"","menuname":"用户（管理员）管理",
                    "menus":[
                        {"menuid":"11","menuname":"用户列表","icon":"icon-user-teacher","url":"../user/userList"}
                    ]
                },
                </c:if>
                {"menuid":"3","icon":"","menuname":"年级信息管理",
                    "menus":[
                        {"menuid":"31","menuname":"年级列表","icon":"icon-world","url":"../grade/gradeList"},
                    ]
                },
                {"menuid":"4","icon":"","menuname":"班级信息管理",
                    "menus":[
                        {"menuid":"41","menuname":"班级列表","icon":"icon-house","url":"../clazz/clazzList"},
                    ]
                },
                {"menuid":"2","icon":"","menuname":"学生信息管理",
                    "menus":[
                        {"menuid":"21","menuname":"学生列表","icon":"icon-user-student","url":"../student/studentList"},
                    ]
                },
...
<div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
    <div class="footer">Copyright &copy; SWU By wz</div>
</div>
